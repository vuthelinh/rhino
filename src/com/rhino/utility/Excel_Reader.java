...
public class Excel_Reader {
		...
		try {
			...
			if (cell != null) {
				...
				case Cell.CELL_TYPE_NUMERIC:
					String tmp[] = String.valueOf(cell.getNumericCellValue()).split("\\.0");
					return tmp[0];
	...
	public int get_total_row_by_value(String sheetName,String colName, String value) {

		int rows = getRowCount(sheetName);
		int total=0;

		for (int i = 1; i <= rows; i++){
			if(getCellData(sheetName, colName, (i+1)).equals(value)) {
				total=total+1;
			}
		}
		return total;
	...
	public ArrayList<String> get_data_cols(String sheetName, String colName) {
		ArrayList<String> dataList = new ArrayList<String>();
		int rows = getRowCount(sheetName);
		for (int i = 1; i <= rows; i++){
			if(!getCellData(sheetName, colName, i).isEmpty()) {
				dataList.add(getCellData(sheetName, colName, i));
		}
//		else{
//			dataList.add("");
//		}
	...
	public ArrayList<String> get_data_cols(String sheetName, String colName, int rows) {
		ArrayList<String> dataList = new ArrayList<String>();
